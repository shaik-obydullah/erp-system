...
@section('content')
<div class="card" x-data="formHandler('{{ route('admins.update', $admin) }}', 'PUT')" x-init="init()">
    <div class="card-header">
        <h2 class="card-title">Edit Admin: {{ $admin->first_name }} {{ $admin->last_name }}</h2>
        ...
        <form @submit.prevent="submit($event)">
            ...
            <div style="display: flex; gap: 12px; margin-top: 24px;">
                <button type="submit" class="btn btn-primary" :disabled="submitting">
                    <span x-show="!submitting">Update Admin</span>
