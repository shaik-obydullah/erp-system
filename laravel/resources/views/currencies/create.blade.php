...
@section('content')
<div class="card" x-data="formHandler('{{ route('currencies.store') }}', 'POST')" x-init="init()">
    <div class="card-header">
        <h2 class="card-title">Create New Currency</h2>
        ...
        <form @submit.prevent="submit($event)">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="code" x-model="form.code" placeholder="USD" required autofocus maxlength="10">
            ...
            <div style="display: flex; gap: 12px; margin-top: 24px;">
                <button type="submit" class="btn btn-primary" :disabled="submitting">
                    <span x-show="!submitting">Create Currency</span>
