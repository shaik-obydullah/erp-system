...
@section('content')
<div class="card" x-data="formHandler('{{ route('bill-of-materials.store') }}', 'POST')" x-init="init()">
    <div class="card-header">
        <h2 class="card-title">Create Bill of Material</h2>
        ...
        <form @submit.prevent="submit($event)">
            ...
            <div style="display: flex; gap: 12px; margin-top: 24px;">
                <button type="submit" class="btn btn-primary" :disabled="submitting">
                    <span x-show="!submitting">Create BOM</span>
