...
@section('title', 'Create Production Planning')

@section('content')
<div class="card" x-data="formHandler('{{ route('production-plannings.store') }}', 'POST')" x-init="init()">
    <div class="card-header">
        <h2 class="card-title">Create Production Planning</h2>
        ...
        <form @submit.prevent="submit($event)">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="quantity" x-model="form.quantity" step="0.01" min="0" required>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="production_cost" x-model="form.production_cost" step="0.01" min="0" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="other_cost" x-model="form.other_cost" step="0.01" min="0">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="expected_profit" x-model="form.expected_profit" step="0.01" min="0">
                ...
                <div class="form-group">
                    ...
                    <div style="display: flex; align-items: center; gap: 8px; padding-top: 8px;">
                        <input type="checkbox" id="finalized" x-model="form.finalized" style="width: 18px; height: 18px;">
            ...
            <div style="display: flex; gap: 12px; margin-top: 24px;">
                <button type="submit" class="btn btn-primary" :disabled="submitting">
                    <span x-show="!submitting">Create Planning</span>
