...
@section('content')
<div class="card" x-data="formHandler('{{ route('fixed-assets.store') }}', 'POST')" x-init="init()">
    <div class="card-header">
        <h2 class="card-title">Add Fixed Asset</h2>
        ...
        <form @submit.prevent="submit($event)">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="price" x-model="form.price" step="0.01" min="0" required>
