        ...
        <div class="layout">
            <aside class="sidebar">
                <div class="sidebar-header">
                    <h2 class="sidebar-logo"><span class="logo-erp">ERP</span><span class="logo-admin">Customer</span></h2>
                </div>
                <nav class="sidebar-nav">
                    ...
                    <a href="{{ route('customer.profile.edit') }}" class="nav-item {{ request()->routeIs('customer.profile.*') ? 'active' : '' }}">
