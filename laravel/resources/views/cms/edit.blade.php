...
@section('content')
<div class="card" x-data="formHandler('{{ route('cms.update', $content) }}', 'PUT')" x-init="init()">
        ...
        <form @submit.prevent="submit($event)">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="slug" x-model="form.slug">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="media" x-model="form.media">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="attribute" x-model="form.attribute">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <textarea id="content" x-model="form.content" rows="8"></textarea>
            ...
            <div style="display: flex; gap: 12px; margin-top: 24px;">
                <button type="submit" class="btn btn-primary" :disabled="submitting">
                    <span x-show="!submitting">Update Content</span>
    ...
    function formHandler(url, method) {
        return {
            form: {
                ...
                attribute: @json($content->attribute),
            ...
            async submit() {
                ...
                try {
                    const response = await fetch(url, {
                        method: method,
                        headers: { 'Content-Type': 'application/json', 'X-CSRF-TOKEN': this.csrfToken, 'X-HTTP-Method-Override': method, 'Accept': 'application/json' },
