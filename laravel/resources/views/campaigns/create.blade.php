...
@section('content')
<div class="card" x-data="formHandler('{{ route('campaigns.store') }}', 'POST')" x-init="init()">
        ...
        <form @submit.prevent="submit($event)">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="budget" x-model="form.budget" step="0.01" min="0" required>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="date" id="end_date" x-model="form.end_date">
