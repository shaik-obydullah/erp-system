...
@section('content')
<div class="card" x-data="formHandler('{{ route('expenses.store') }}', 'POST')" x-init="init()">
        ...
        <form @submit.prevent="submit($event)">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="description" x-model="form.description" required autofocus>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" id="amount" x-model="form.amount" step="0.01" min="0" required>
        ...
        return {
            ...
            async submit() {
                ...
                try {
                    ...
                    if (response.ok) {
                        window.location.href = data.redirect || '{{ route("expenses.index") }}';
                        return;
                    }
                    if (data.errors) {
                        this.errors = {};
