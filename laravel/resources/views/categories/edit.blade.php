...
@section('content')
<div class="card" x-data="formHandler('{{ route('categories.update', $category) }}', 'PUT')" x-init="init()">
    ...
    <div class="card-body">
        ...
        <form @submit.prevent="submit($event)">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    <label for="fk_category_id">Parent Category</label>
    ...
    function formHandler(url, method) {
        return {
            form: {
                ...
                fk_category_id: '{{ old('fk_category_id', $category->fk_category_id) }}',
