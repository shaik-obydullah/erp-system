...
@section('content')
<div class="card" x-data="formHandler('{{ route('employees.store') }}', 'POST')" x-init="init()">
        ...
        <form @submit.prevent="submit($event)">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="text" id="job_title" x-model="form.job_title">
                    <span class="form-error" x-show="errors.job_title" x-text="errors.job_title"></span>
                </div>
                <div class="form-group">
                    <label for="salary">Salary *</label>
                    <input type="number" id="salary" x-model="form.salary" step="0.01" min="0" required>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="date" id="hire_date" x-model="form.hire_date">
            ...
            <div style="display: flex; gap: 12px; margin-top: 24px;">
                <button type="submit" class="btn btn-primary" :disabled="submitting">
                    <span x-show="!submitting">Create Employee</span>
