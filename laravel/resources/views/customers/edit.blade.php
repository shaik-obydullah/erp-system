...
@section('content')
<div class="card" x-data="formHandler('{{ route('customers.update', $customer) }}', 'PUT')" x-init="init()">
    <div class="card-header">
        <h2 class="card-title">Edit Customer: {{ $customer->name }}</h2>
    ...
    <div class="card-body">
        ...
        <form @submit.prevent="submit($event)">
            ...
            <div class="form-row">
                <div class="form-group">
                    <label for="password">Password <small style="color: var(--text-secondary);">(leave blank to keep current)</small></label>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <span class="form-error" x-show="errors.phone" x-text="errors.phone"></span>
                </div>
                <div class="form-group">
            ...
            <div style="display: flex; gap: 12px; margin-top: 24px;">
                <button type="submit" class="btn btn-primary" :disabled="submitting">
                    <span x-show="!submitting">Update Customer</span>
    ...
    function formHandler(url, method) {
        return {
            form: {
                ...
                status: '{{ old('status', $customer->status) }}',
            },
            errors: {},
            errorMessage: '',
            successMessage: '',
