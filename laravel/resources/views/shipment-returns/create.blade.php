...
@section('title', 'Create Shipment Return')

@section('content')
<div class="card" x-data="formHandler('{{ route('shipment-returns.store') }}', 'POST')" x-init="init()">
    <div class="card-header">
        <h2 class="card-title">Add Shipment Return</h2>
        ...
        <form @submit.prevent="submit($event)">
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="invoice_amount" x-model="form.invoice_amount" step="0.01" min="0" required>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <textarea id="return_reason" x-model="form.return_reason" rows="3" required></textarea>
